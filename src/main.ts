...
import { CHAIN_RPC_URL, DEPEG_PRODUCT_ADDRESS, MAX_FEE_PER_GAS, MAX_PRIORITY_FEE_PER_GAS, PROCESSOR_EXPECTED_BALANCE, PROCESSOR_MNEMONIC } from './constants';
...
class Main {
    ...
    public async main(): Promise<void> {
        ...
        // initializeRedis();
        new QueueListener().listen(depegProductAddress, signer, maxFeePerGas, maxPriorityFeePerGas, processorExpectedBalance);
    }
